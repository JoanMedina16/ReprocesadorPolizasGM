   ...
   public class LOGI_FondoFijo_PD
    {
        ...
        const string CONST_MODULO = "FondoFijo";

        public LOGI_FondoFijo_PD(string sConnbitacora, string sConnopeadm)
        {
        ...
        public string GenerarPolizasComprobacionGasto(LOGI_FondoFijo_INFO oFondofijo)
        {
            string response = "ERROR", tipo = string.Empty, mensaje = string.Empty, sConsultaSql = string.Empty;
            try
            {
        ...
        public string ConsultaBitacoraComprobacionGasto(string sUsuarioID, LOGI_Bitacora_INFO oParam, ref LOGI_Bitacora_INFO oBitacora)
        {
            string sReponse = string.Empty, sConsultaSql = string.Empty;
            sReponse = "ERROR";
            try
            {
                ...
                DataSet odataset = new DataSet();
                bool bAnd = false;
                sConsultaSql = string.Format(@"SELECT folio_tms FROM lm_tms_liquidacion_viaje ");
            ...
            catch (Exception ex)
            {
                ...
                oTool.LogError(ex, "ConsultaBitacoraComprobacionGasto", sUsuarioID, CONST_CLASE, CONST_MODULO, sDatosAdicionales: sConsultaSql);
                sReponse = string.Format("No se ha podido recuperar la información {0}", ex.Message);
            }
            finally
            {
