<div class="card-body">
    <div class="row">
        ...
        <div class="col-10">
              <div class="row">
                   <div class="col-1">
                        <label class="form-control-sm">Elementos:</label>
                        <input class="form-control css-texto form-control-sm" id="txtnum_page" onkeypress="return oGlob.m_campoEspecialLetras(event)" type="text" placeholder="Elementos" readonly="readonly">
                    </div>
                  <div class="col-3">
                        <label class="form-control-sm">Importe total:</label>
                        <input class="form-control css-texto form-control-sm" id="txtotal_page" onkeypress="return oGlob.m_campoEspecialLetras(event)" type="text" placeholder="Importe" readonly="readonly">
                    </div>                  
                  <div class="col-4">
                        <label class="form-control-sm">Litros total:</label>
                        <input class="form-control css-texto form-control-sm" id="txlitros_page" onkeypress="return oGlob.m_campoEspecialLetras(event)" type="text" placeholder="Litros total" readonly="readonly">
                    </div>
                                  
                  <div class="col-4">
                        <label class="form-control-sm">Precio esimado:</label>
                        <input class="form-control css-texto form-control-sm" id="txtprecio_page" onkeypress="return oGlob.m_campoEspecialLetras(event)" type="text" placeholder="Precio estimado" readonly="readonly">
                    </div>
              </div>
        </div>
    </div>
...
<script>
    var oCombuslista = null;
    $(document).ready(function () {
        oCombuslista = new Cargascombustible();
        oCombuslista.m_InicializaEvents();
    });
</script>
