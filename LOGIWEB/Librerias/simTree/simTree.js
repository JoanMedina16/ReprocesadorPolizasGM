(function ($) {
    ...
    var defaults = {
        ...
        css: {
            list: 'fa-ul',
            listItem: 'fa-li fa fa-lg handclass',
    ...
    function _init() {
        ...
        //me.on('change', 'fa-li fa', __changeHandler);
        //me.on('click', 'fa-li fa', __changeHandler);
