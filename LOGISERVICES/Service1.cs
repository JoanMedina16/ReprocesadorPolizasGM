...
namespace LOGISERVICES
{
    public partial class Service1 : ServiceBase
    {
        ...
        internal Timer Timer_Propasivos;
        List<Timer> _timersProcesosActivos ;
        public Service1()
        {
            InitializeComponent();
        }
    ...
    //    */
        ...
        protected override void OnStart(string[] args)
        {
            ...
            */
            ...
            Timer_EnviaPasivosUno = new Timer(new TimerCallback(TimerSincronizaPasivoSemanaUnoD365_Object), null, oInicioIntervalo, oIntervalo);
        ...
        private void TimerEjecucionProceso_Object(object state)
        {
            ...
            try
            {
                var parametros = state as Dictionary<string, object>;
                if (parametros == null) return;

                //LOGI_ControlProcesos_INFO proceso = state as LOGI_ControlProcesos_INFO;
                //if (proceso == null) return;
                LOGI_ControlProcesos_INFO proceso = parametros["proceso"] as LOGI_ControlProcesos_INFO;
                string tipoProceso = parametros["tipoProceso"] as string;
                if (proceso == null) return;


                oTools.LogProceso($"Ejecutando proceso ID: {tipoProceso}",
                                 "TimerEjecucionProceso_Object", CONST_CLASE, CONST_MODULO, CONST_USUARIO);
                ...
                if (this.GetConfig(ref oCredencial, ref oConfiguracion))
                {
                    if (oConfiguracion.sincd365 == 1)
                    {
                        ...
                        if (oConectionIngresoPago.onCreateLogin())
                        {
                            ...
                            {
                                ProFacturas = Convert.ToBoolean(proceso.ProFacturas),
                                ProCancelacionFacturas = Convert.ToBoolean(proceso.ProCancelacionFacturas),
                                ProNotasCredito = Convert.ToBoolean(proceso.ProNotasCredito),
                                ProMovimientosBancarios = Convert.ToBoolean(proceso.ProMovimientosBancarios),
                                ProPasivos = Convert.ToBoolean(proceso.ProPasivos)
                            };
                            // Actualizar estado del proceso a "en ejecución"
                            //proceso.Estado = 1; // En ejecución

                            //resultcProcesos.ActualizaControlProcesos(proceso, eProceso);

                            oTools.LogProceso("DescargaMovimientoTMS", "TimerEjecucionProceso_Object", CONST_CLASE, CONST_MODULO, CONST_USUARIO);
                           // LOGI_EstadoControlProcesos_INFO
                            // Ejecutar el proceso específico
                            //Proceso = 
                            bool procesado= oConectionIngresoPago.DescargaEjecutaProcesos(tipoProceso,
                                CONST_CONNECTION_LOG,
                                proceso.FechaInicial.ToString("dd/MM/yyyy"),
                                proceso.FechaInicial.ToString("dd/MM/yyyy"),
                                false,
                                true,
                                proceso.ProFacturas,
                                proceso.ProCancelacionFacturas,
                                proceso.ProNotasCredito,
                                proceso.ProMovimientosBancarios,
                                proceso.ProPasivos);
                            
                            // Actualizar estado del proceso a "completado"
                            proceso.Estado = 2; // Completado
                            //resultcProcesos.ActualizaControlProcesos(proceso, eProceso);                             }
                        }
                    }
                    else
                    {
                        oTools.LogProceso("No se ha podido leer la configuración para el servicio",
                                         "TimerEjecucionProceso_Object", CONST_CLASE, CONST_MODULO, CONST_USUARIO);
                    }
                }
            }
            ...
            {
                oTools.LogError(ex, "TimerEjecucionProceso_Object=> CATCH", CONST_USER, CONST_CLASE, CONST_MODULO);
            }
            finally
            {
                _enEjecucion = false;
                            ...
                            if (File.Exists(oFile.FullName))
                            {
                                ...
                                if (this.GetConfig(ref oCredencial, ref oConfiguracion))
                                {
                                    ...
                                    if (oConfiguracion.sincd365 == 1)
                                    {
                                        ...
                                        {
                                            oConectionAntiguos.DescargaEjecutaMovimientosPasivos(CONST_CONNECTION_LOG,oTiempos.fechainicio.ToString("dd/MM/yyyy"), oTiempos.fechafinal.ToString("dd/MM/yyyy"), bIgnoraFechas:true);

                                            oTools.LogProceso("onLoadJSONFolder", "TimerSincronizaIngresoReposicionD365_Object", CONST_CLASE, CONST_MODULO, CONST_USUARIO);
                                            oConectionAntiguos.DescargaEjecutaMovimientosIngreso(oConfiguracion, CONST_CONNECTION_LOG, oTiempos.fechainicio.ToString("dd/MM/yyyy"), oTiempos.fechafinal.ToString("dd/MM/yyyy"), bCreaArchivoJSON:false);
        ...
        private void TimerSincronizaIngresoReposicionD365_Object(object state)
        {
            ...
            Console.WriteLine("El proceso de movimientos de ingreso ha comenzado...");
            try
            {
                    ...
                    if (oConfiguracion.sincd365 == 1)
                    {
                        ...
                        if (oConectionIngresoPago.onCreateLogin())
                        {
                            ...
                            foreach (LOGI_ControlProcesos_INFO cProceso in cProcesos)
                            {
                                LOGI_EstadoControlProcesos_INFO eProceso = new LOGI_EstadoControlProcesos_INFO
                                {
                                    ProFacturas = Convert.ToBoolean(cProceso.ProFacturas),
                                    ProCancelacionFacturas = Convert.ToBoolean(cProceso.ProCancelacionFacturas),
                                    ProNotasCredito = Convert.ToBoolean(cProceso.ProNotasCredito),
                                    ProMovimientosBancarios = Convert.ToBoolean(cProceso.ProMovimientosBancarios),
                                    ProPasivos = Convert.ToBoolean(cProceso.ProPasivos)
                                };
                               ...
                               resultcProcesos.ActualizaControlProcesos(cProceso, eProceso);
                                ...
                                eProceso = oConectionIngresoPago.DescargaEjecutaMovimientosIngreso(oConfiguracion, CONST_CONNECTION_LOG, cProceso.FechaInicial.ToString("dd/MM/yyyy"), cProceso.FechaInicial.ToString("dd/MM/yyyy"), false, true, cProceso.ProFacturas, cProceso.ProCancelacionFacturas, cProceso.ProNotasCredito, cProceso.ProMovimientosBancarios, cProceso.ProPasivos);
                            ...
                            Console.WriteLine("El Login no se ha creado...");
                    }
                    //CONST_PAUSA = oTools.GetTiempoSleepSegmento(0, oConfiguracion.enviohorad365, Convert.ToInt32(CONST_ENVIO_COMBUS), oConfiguracion.enviosegd365);
                }
                else oTools.LogProceso("No se ha podido leer la configuración para el servicio", "OnStart", CONST_CLASE, CONST_MODULO, CONST_USUARIO);
            ...
            {
                Console.WriteLine("El proceso ha finalizado, Esperando...");
                _enEjecucion = false;
            }
        ...
        private void TimerSincronizaPasivoSemanaUnoD365_Object(object state)
        {
            ...
            Console.WriteLine("El proceso de movimientos de Pasivos semana uno ha comenzado...");
                ...
                if (this.GetConfig(ref oCredencial, ref oConfiguracion))
                {
                    ...
                    if (oConfiguracion.sincd365 == 1)
                    {
                        ...
                        if (oConectionPasivoUno.onCreateLogin())
                        {
                            ...
                            oConectionPasivoUno.DescargaEjecutaMovimientosPasivos(CONST_CONNECTION_LOG,oBloque.fechainicio.ToString("dd/MM/yyyy"), oBloque.fechafinal.ToString("dd/MM/yyyy"));
                            //}
                        }
                    }
                }
                    ...
                    if (oConfiguracion.sincd365 == 1)
                    {
                        ...
                        if (oConectionPasivodos.onCreateLogin())
                        {
                            ...
                            //{
                                ...
                                oConectionPasivodos.DescargaEjecutaMovimientosPasivos(CONST_CONNECTION_LOG, oBloque.fechainicio.ToString("dd/MM/yyyy"), oBloque.fechafinal.ToString("dd/MM/yyyy"));
                            //}
                        }
                    }
                }
                    ...
                    if (oConfiguracion.sincd365 == 1)
                    {
                        ...
                        if (oConectionPasivoTres.onCreateLogin())
                        {
                            ...
                            //{
                                ...
                                oConectionPasivoTres.DescargaEjecutaMovimientosPasivos(CONST_CONNECTION_LOG,oBloque.fechainicio.ToString("dd/MM/yyyy"), oBloque.fechafinal.ToString("dd/MM/yyyy"));
                            //}
                        }
                    }
                }
                    ...
                    if (oConfiguracion.sincd365 == 1)
                    {
                        ...
                        if (oConectionPasivoCuatro.onCreateLogin())
                        {
                            ...
                            //{
                                ...
                                oConectionPasivoCuatro.DescargaEjecutaMovimientosPasivos(CONST_CONNECTION_LOG, oBloque.fechainicio.ToString("dd/MM/yyyy"), oBloque.fechafinal.ToString("dd/MM/yyyy"));
                            //}
                        }
                    }
                }
